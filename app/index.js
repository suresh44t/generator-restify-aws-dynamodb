...
module.exports = yeoman.generators.Base.extend({
    ...
    writing: {
        app: function () {
            ...
            copyIdenticalPaths('routes/home.js');

            copyIdenticalPaths('test/server.js');
            copyIdenticalPaths('test/routes/home.js');
        ...
        projectfiles: function () {
            ...
            copyTemplateToDest('_moviedata.json', 'moviedata.json', {
                appname: _s.slugify(this.props.appName)
            });

            copyTemplateToDest('_envrc', '.envrc', {
                appname: _s.slugify(this.props.appName)
            });
